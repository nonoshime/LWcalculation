...
//ラストワード弾幕種類（通常0,御札1,エネ2,肉3,斬撃4,レーザー5,質量6,光7,流体8,尖弾9）
var lw_type_table = [
    ["博麗霊夢", 1, 1, 1, 2, 2, 2],
    ["霧雨魔理沙", 3, 3, 3, 3, 3, 3],
...
var lw_power_table = [
    ...
    ["八意永琳", 6.16, 18.48, 21.56, 24.64, 27.72, 30.80],
    ["蓬莱山輝夜", 6.86, 14.63, 17.07, 19.50, 21.94, 24.38],
    ["藤原妹紅", 11.45, 20.95, 22.69, 36.55, 39.27, 41.89],
    ["清蘭", 19.59, 21.94, 18.29, 21.94, 16.46, 21.94],
    ["鈴瑚", 19.59, 21.94, 27.43, 43.89, 32.91, 21.94],
    ["レイセン", 0, 0, 0, 0, 0, 0],
    ["聖白蓮", 7.53, 14.63, 15.85, 25.60, 27.43, 29.26],
    ["茨木華扇", 10.50, 19.20, 20.80, 33.60, 36.00, 38.40],
    ["稀神サグメ", 5.22, 10.97, 12.80, 14.63, 16.46, 18.29]
];
...
var lw_hit_table = [
    ...
    ["八意永琳", 0.85, 0.85, 0.85, 0.85, 0.85, 0.85],
    ["蓬莱山輝夜", 0.75, 0.75, 0.75, 0.75, 0.75, 0.75],
    ["藤原妹紅", 0.75, 0.75, 0.75, 0.75, 0.75, 0.75],
    ["清蘭", 0.75, 0.75, 0.75, 0.75, 0.75, 0.75],
    ["鈴瑚", 0.75, 0.75, 0.75, 0.75, 0.75, 0.75],
    ["レイセン", 0, 0, 0, 0, 0, 0],
    ["聖白蓮", 0.75, 0.75, 0.75, 0.75, 0.75, 0.75],
    ["茨木華扇", 0.75, 0.75, 0.75, 0.75, 0.75, 0.75],
    ["稀神サグメ", 0.75, 0.75, 0.75, 0.75, 0.75, 0.75]
];
...
var lw_cri_table = [
    ...
    ["八意永琳", 0.10, 0.10, 0.10, 0.10, 0.10, 0.10],
    ["蓬莱山輝夜", 0.05, 0.05, 0.05, 0.05, 0.05, 0.05],
    ["藤原妹紅", 0.10, 0.10, 0.10, 0.10, 0.10, 0.10],
    ["清蘭", 0.05, 0.05, 0.05, 0.05, 0.05, 0.05],
    ["鈴瑚", 0.05, 0.05, 0.05, 0.05, 0.05, 0.05],
    ["レイセン", 0, 0, 0, 0, 0, 0],
    ["聖白蓮", 0.05, 0.05, 0.05, 0.05, 0.05, 0.05],
    ["茨木華扇", 0.20, 0.20, 0.20, 0.20, 0.20, 0.20],
    ["稀神サグメ", 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]
];
...
//ラストワード追加効果（無し0,硬質1,貫通2,斬裂3,爆破4,弾性5,必中6）
...
var lw_level_table = [
    ...
    ["八意永琳", 1.00, 1.07, 1.14, 1.21, 1.28],
    ["蓬莱山輝夜", 1.00, 1.07, 1.14, 1.21, 1.28],
    ["藤原妹紅", 1.00, 1.08, 1.15, 1.22, 1.30],
    ["清蘭", 1.00, 1.07, 1.13, 1.20, 1.26],
    ["鈴瑚", 1.00, 1.07, 1.13, 1.20, 1.26],
    ["レイセン", 0, 0, 0, 0, 0],
    ["聖白蓮", 1.00, 1.07, 1.14, 1.21, 1.28],
    ["茨木華扇", 1.00, 1.07, 1.15, 1.22, 1.30],
    ["稀神サグメ", 1.00, 1.07, 1.14, 1.21, 1.28]
];
...
function recalculation(){
    ...
    for(var i = 0; i < bstType; i++){
        ...
        //能力によるダメージアップ（有利属性）
        var abi1 = document.querySelector("#ability1").value;
        abi1 = parseInt(abi1)/100 + 1;
        if((attribution == 2)||(attribution == 5)){
            pro_damage = pro_damage*abi1
            pro_damage2 = pro_damage2*abi1
            pro_damage3 = pro_damage3*abi1
            cridamage = cridamage*abi1
            cridamage2 = cridamage2*abi1
            cridamage3 = cridamage3*abi1
        }
        //能力によるダメージアップ（不利属性）
        var abi2 = document.querySelector("#ability2").value;
        abi2 = parseInt(abi2)/100 + 1;
        if((attribution == 3)||(attribution == 8)){
            pro_damage = pro_damage*abi2
            pro_damage2 = pro_damage2*abi2
            pro_damage3 = pro_damage3*abi2
            cridamage = cridamage*abi2
            cridamage2 = cridamage2*abi2
            cridamage3 = cridamage3*abi2
        }
